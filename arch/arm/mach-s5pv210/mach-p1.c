...
static enum sec_cable_type_t set_cable_status;
...
static struct platform_device p1_s3c_device_i2c12 = {
	.name			= "i2c-gpio",
	.id			= 12,
...
static struct platform_device p1_s3c_device_i2c14 = {
	.name			= "i2c-gpio",
	.id			= 14,
...
off:
	...
	err = regulator_disable(cam_io_regulator); initializer but incomplete type
...
static void fsa9480_usb_cb(bool attached)
{
	...
	set_cable_status = attached ? SEC_CABLE_TYPE_USB : SEC_CABLE_TYPE_NONE;
...
{
	set_cable_status = attached ? SEC_CABLE_TYPE_AC : SEC_CABLE_TYPE_NONE;
	if (callbacks && callbacks->set_cable)
		callbacks->set_cable(callbacks, set_cable_status);
...
{
	return (ap_vbus_disabled ? SEC_CABLE_TYPE_NONE : set_cable_status);
}
