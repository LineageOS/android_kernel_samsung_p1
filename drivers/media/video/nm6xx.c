...
const char * const *nm6xx_ctrl_get_menu(u32 id)
{
	switch (id) {
#if 0
	/* Sample code */
 ...
 *
 * */
static int nm6xx_s_mbus_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *fmt)
{
	int err = 0;
	struct nm6xx_state *state = to_state(sd);
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int nm6xx_enum_mbus_fmt(struct v4l2_subdev *sd, unsigned int index,                                   
...
static int nm6xx_try_mbus_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *fmt)  
{
	int num_entries;
	int i;
...
static const struct v4l2_subdev_video_ops nm6xx_video_ops = {
	...
	.g_fmt = nm6xx_g_fmt,
	.s_mbus_fmt = nm6xx_s_mbus_fmt,
	.enum_framesizes = nm6xx_enum_framesizes,
	.enum_frameintervals = nm6xx_enum_frameintervals,
	.enum_mbus_fmt = nm6xx_enum_mbus_fmt, 
	.try_mbus_fmt = nm6xx_try_mbus_fmt,
	.g_parm = nm6xx_g_parm,
	.s_parm = nm6xx_s_parm,
};
			 ...
			 const struct i2c_device_id *id)
{
	...
	struct v4l2_subdev *sd;
	struct nm6xx_platform_data *pdata = client->dev.platform_data;
