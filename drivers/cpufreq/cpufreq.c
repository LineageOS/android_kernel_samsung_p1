...
static ssize_t show_int_UV_mV_table(struct cpufreq_policy *policy, char *buf) {
  ...
  return sprintf(buf, "%d %d %d %d %d %d\n", exp_int_UV_mV[0], exp_int_UV_mV[1], exp_int_UV_mV[2], exp_int_UV_mV[3], exp_int_UV_mV[4], exp_int_UV_mV[5]);
...
static ssize_t store_int_UV_mV_table(struct cpufreq_policy *policy,
  ...
  ret = sscanf(buf, "%d %d %d %d %d %d", &exp_int_UV_mV[0], &exp_int_UV_mV[1], &exp_int_UV_mV[2], &exp_int_UV_mV[3], &exp_int_UV_mV[4], &exp_int_UV_mV[5]);
  if(ret != 1) {
    return -EINVAL;
  }
  else
